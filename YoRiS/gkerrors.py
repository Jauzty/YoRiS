...
plt.scatter(red, log_gk_mcmc, color = 'red', marker = 's', s = 20, label = 'MCMC match, with scatter, FRI')
plt.scatter(redII, log_gk_mcmcFRII, color = 'blue', marker = '*', s = 20, label = 'MCMC match, with scatter, FRII')
...
plt.legend(loc="upper center", bbox_to_anchor=(0.45, -0.13), fontsize=16, framealpha=0)
plt.ylim(-1.5, 0.25)
plt.xlabel('Redshift (z)')
plt.ylabel('$log(g_{k})$')
