...
plt.scatter(red, log_gk_fri_H, color='black', marker='o', label='FRI')
...
plt.scatter(red, log_gk_friiH, color='black', marker='^', label='FRII')
#plt.scatter(red, loggkfrinew, color ='red', marker = 'd', label = 'FRI ?')
